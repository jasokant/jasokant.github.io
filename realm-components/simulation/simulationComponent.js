...
realm_components.directive('simulationComponent', ['$timeout', '$http', '$q', 'RobotService', function($timeout, $http, $q, RobotService) {
        ...
        compile: function CompilingFunction(tElement, tAttrs)
        {
            ...
            return function LinkingFunction(scope, element, attrs, ctrl) {
                ...
                function init() {
                    ...
                    //document.body.realmendChild( container );
                    //$element.find('.simulation').realmend(container);
                    ...
                    container.realmend( renderer.domElement );
                ...
                function render() 
                {
                    ...
                    $.getJSON("'http://realmproject.net:8443/realm/rest/device/mico'",ajaxSuccess);
                    
                    $.ajax({
                      dataType: "jsonp",
                      url: "'http://realmproject.net:8443/realm/rest/device/mico'",
                      data: data,
                      success: ajaxSuccess
                    });
