...
realm_components.directive('poseInputComponent', ['$timeout', '$http', '$q', 'RobotService', function($timeout, $http, $q, RobotService) {
    ...
    return {
        ...
        {
           // elements.a.bind('click', function(){scope.$realmly(function(){scope.x++}); alert("works!")});
